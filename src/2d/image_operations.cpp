...
private:
  ResizeFilter(ResizeFilter &other);
  void operator=(ResizeFilter &other);
};
...
void ResizeFilter::ComputeFilters(int src_size,
  ...
  // FIXME: Replace with some sort of small_vector class. I didn't want a
  // dependency on Chromium code, so I'm willing to take the malloc perf
  // hit. --pcwalton
